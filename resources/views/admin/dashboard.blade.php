...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="7"
                link="{{ route('admin.plans.booking.log') }}"
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="7"
                link="{{ route('admin.plans.booking.running.log') }}"
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="7"
                link="{{ route('admin.plans.booking.upcoming.log') }}"
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                style="7"
                link="{{ route('admin.plans.booking.completed.log') }}"
