...
Route::middleware('admin')->group(function () {
    ...
    // Plans
    Route::controller('ManagePlanController')->name('plans.')->prefix('plans')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('add', 'add')->name('add');
        Route::post('store/{id?}', 'store')->name('store');
        ...
        //Plan Booking Log
        Route::get('booking/log', 'bookingLog')->name('booking.log');
        Route::get('booking/log/upcoming', 'upcomingBookingLog')->name('booking.upcoming.log');
        Route::get('booking/log/running', 'runningBookingLog')->name('booking.running.log');
        Route::get('booking/log/completed', 'completedBookingLog')->name('booking.completed.log');
        //User Plan Booking Log
        Route::get('booking/log/{id}', 'userBookingLog')->name('user.booking.log');
        Route::get('booking/log/{id}/upcoming', 'userUpcomingBookingLog')->name('user.booking.upcoming.log');
        Route::get('booking/log/{id}/running', 'userRunningBookingLog')->name('user.booking.running.log');
        Route::get('booking/log/{id}/completed', 'userCompletedBookingLog')->name('user.booking.completed.log');
    });
